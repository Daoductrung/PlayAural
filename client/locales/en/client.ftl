...
options-spatial-audio-label = Spatial Audio:
options-spatial-audio-off = Off (plain stereo)
options-spatial-audio-stereo = Stereo (for speakers)
options-spatial-audio-headphones = Headphones (3D, HRTF)
