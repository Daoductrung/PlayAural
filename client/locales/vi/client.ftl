...
history-buffer-current = Bộ đệm: { $name }
history-buffer-muted-name = [Đã tắt tiếng] { $name }
history-buffer-muted-by-all = Bộ đệm { $name } đang bị tắt tiếng bởi Tất cả. Hãy chọn Tất cả để bật tiếng.
history-buffer-muted-empty = Bộ đệm { $name } đang bị tắt tiếng. Hãy bật tiếng để xem nhật ký của bộ đệm này.
...
options-spatial-audio-label = Âm thanh không gian:
options-spatial-audio-off = Tắt (âm thanh nổi thông thường)
options-spatial-audio-stereo = Âm thanh nổi (dành cho loa)
options-spatial-audio-headphones = Tai nghe (3D, HRTF)
