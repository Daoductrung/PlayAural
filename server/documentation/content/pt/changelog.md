...
* Gestos no touchpad do DualSense no computador: clique físico abre a lista de usuários com jogos, deslizar para cima lê os usuários online, deslizar para baixo alterna entre jogador e espectador, deslizar com um dedo para os lados silencia o buffer atual ou o bate-papo da mesa, deslizar com dois dedos para os lados silencia o bate-papo global ou consulta a latência, deslizar com dois dedos na vertical ajusta o volume da música, e um toque suave anuncia de quem é a vez.
