...
* **E-mail:** trung@ddt.one
* **Telegram:** @daoductrung
* **Formulário de contato no site:** https://ddt.one/contact

# **O Que Incluir**

Para obter a resposta mais rápida e clara, inclua os detalhes relevantes em sua mensagem:
...
O feedback de acessibilidade é especialmente valioso. Se um som, mensagem falada, ordem de menu, atalho, gesto ou página de documentação não estiver claro, descreva onde aconteceu e o que tornaria mais fácil de entender.

# **Problemas de Comunidade e Segurança**

Se precisar relatar assédio, spam, trapaça, preocupações com privacidade ou outro problema de segurança da comunidade, inclua os nomes de usuário envolvidos, o horário aproximado e uma descrição clara do que aconteceu.

# **Tempo de Resposta**

As mensagens são respondidas quando o tempo permite. Alguns problemas podem demorar mais para serem revisados, especialmente relatórios de bugs de contas, moderação, servidores ou técnicos.
