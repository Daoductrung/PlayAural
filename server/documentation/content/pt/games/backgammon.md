...
Se você pousar em um ponto com exatamente uma peça oponente, essa peça é capturada e enviada para a barra.
...
* **Comprimento da Partida:** O número de pontos necessários para vencer a partida. Um valor de 1 é um jogo único sem cubo de redobro (padrão 1, intervalo de 1 a 25).
...
* **Ctrl+Seta para Baixo ou Ctrl+Seta para a Direita:** Cicla para a frente pelos alvos de navegação. Com uma peça selecionada, cicla pelos destinos disponíveis (manchas do oponente primeiro). Sem uma seleção, cicla pelos pontos de origem que possuem movimentos legais.
