...
* A posição do croupier (dealer) se move um assento no sentido horário.
* Cada jogador com fichas paga o ante para o pote.
* Cada jogador recebe cinco cartas particulares.
* A primeira rodada de apostas começa com o primeiro jogador ativo à esquerda do croupier.

O ante é pago automaticamente. Um jogador que tiver menos fichas do que o ante coloca todas as fichas restantes e está all in.
...
Se todos, exceto um jogador, desistirem, esse jogador ganha as fichas não contestadas imediatamente e o jogo inicia a próxima mão.
...
* **Valor para pagar:** ouve quantas fichas você precisa para pagar. Espectadores e jogadores que não estão mais na mão ouvem a aposta atual da mesa.
...
Espectadores podem usar as ações de informação pública, mas não podem ler a mão particular de um jogador.
