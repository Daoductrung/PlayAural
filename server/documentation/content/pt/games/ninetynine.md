...
**Variante Padrão (Padrão)**



* **Ás:** Escolha +1 ou +11. Joga-se automaticamente como +1 se a contagem estiver acima de 88.

* **2:** Se a contagem for par e acima de 49, divide a contagem por 2. Caso contrário, dobra-a.

* **3, 5-8:** Adiciona o valor de face.

* **9:** Carta de passagem (adiciona 0).

* **10:** Escolha +10 ou -10. Joga-se automaticamente como -10 se a contagem for 90 ou mais.

* **Valete:** Adiciona 10 e pula o próximo jogador.

* **Dama/Rei:** Adiciona 10.

* **4:** Adiciona 4 e inverte a direção do turno.



**Variante de Cartas de Ação**



Usa um baralho de 60 cartas (1-9 e cartas especiais):



* **1-9:** Adiciona o valor de face.

* **+10 / -10:** Adiciona ou subtrai 10.
...
**Marcos e Penalidades (Variante Padrão)**
...
* **Variante de Regras:** Escolha Regras Padrão ou Cartas de Ação (padrão Padrão).
