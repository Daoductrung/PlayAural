...
No final do número escolhido de rodadas, o jogador com a pontuação total mais baixa vence.

**Seu Turno**

1. Role todos os cinco dados.

2. Guarde pelo menos um dado.

3. Role os dados restantes que não foram guardados.

4. Guarde pelo menos mais um dado após cada rolagem.

5. Continue até que o turno esteja totalmente decidido.
...
* Cada 3 vale 0 pontos.

* Cada 1, 2, 4, 5 ou 6 vale o seu valor de face.
...
Você rola 3, 5, 2, 6 e 3. Você guarda ambos os 3s porque eles pontuam 0.

Você rola os outros três dados e obtém 4, 1 e 6. Você guarda o 1.

Você rola os últimos dois dados e obtém 3 e 5. Você guarda o 3. O 5 final é então pontuado automaticamente.

A pontuação do seu turno é 0 + 0 + 1 + 0 + 5 = 6 pontos.
...
* **1-6:** No modo de valores de dados, libera um dado guardado correspondente.
