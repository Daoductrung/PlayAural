...
Seja o primeiro jogador a alcançar ou ultrapassar a pontuação alvo após uma rodada de pontuação. O alvo padrão é 60 pontos.

**Uma Rodada**

Cada rodada tem três mãos. Cada mão tem duas fases: troca e retirada.

**Fase de Troca**

1. Todos os jogadores rolam 5 dados.

2. Todos os 5 dados começam marcados para troca.
...
Você pode trocar todos os 5 dados, guardar todos os 5 dados ou escolher qualquer coisa intermediária.
...
Após cada dado ser retirado, o turno passa para o próximo jogador que ainda precisa de dados. Se você guardou todos os 5 dados, você pula a fase de retirada para essa mão.

**Pontuação**

Após a terceira mão, cada jogador tem 15 dados. O jogo verifica todas as combinações possíveis de pontuação e escolhe a combinação que vale mais pontos. Um dado só pode pertencer a um conjunto.
...
* **Conferir pontuações:** Ouve os totais de pontuação atuais.

**Atalhos de Teclado**

Fase de troca:

* **1-5:** Alternar dados por posição ao usar Índices de dados.

* **1-6:** Guardar um dado correspondente ao usar Valores de dados.

* **Shift+1-6:** Marcar um dado guardado correspondente para troca ao usar Valores de dados.

* **B:** Confirmar suas escolhas de troca.
