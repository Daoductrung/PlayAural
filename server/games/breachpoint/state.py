...
REACTION_PLANT = "plant"
REACTION_DEFUSE = "defuse"
REACTION_WATCHED_ENTRY = "watched_entry"
REACTION_KINDS = frozenset({REACTION_PLANT, REACTION_DEFUSE, REACTION_WATCHED_ENTRY})
