...
breachpoint-error-primary-owned = You already have a primary weapon. Keep it for this round or wait until it is lost before buying another.
...
breachpoint-error-aim-unavailable = Your equipped weapon does not use a prepared angle.
...
breachpoint-buy-turn = Your buy: ${ $cash }, { $weapon } equipped, { $armor } armor, equipment: { $equipment }, utility: { $utility }.
...
# Status and score
breachpoint-position-status = You are { $team } at { $location }. Health: { $health } of { $max_health }. Armor: { $armor }. Equipped: { $weapon }. Equipment: { $equipment }. Utility: { $utility }. Cash: ${ $cash }. Action points: { $ap }. Evasion: { $guard }. Prepared angle: { $angle }.
