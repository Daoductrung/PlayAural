...
breachpoint-action-shoot = Shoot { $player } with { $weapon } at { $location }, { $health } health, { $armor } armor, { $guard } evasion, { $strength } ({ $cost } AP)
...
breachpoint-buy-turn = Your buy: ${ $cash }. Primary: { $primary }. Sidearm: { $sidearm }. Equipped: { $equipped }. Armor: { $armor }. Equipment: { $equipment }. Utility: { $utility }.
...
# Status and score
breachpoint-position-status = You are { $team } at { $location }. Health: { $health } of { $max_health }. Armor: { $armor }. Primary: { $primary }. Sidearm: { $sidearm }. Equipped: { $equipped }. Equipment: { $equipment }. Utility: { $utility }. Cash: ${ $cash }. Action points: { $ap }. Evasion: { $guard }. Prepared angle: { $angle }.
