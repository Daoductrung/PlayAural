...
# Options
breachpoint-set-match-format = Formato da partida: { $format }
breachpoint-select-match-format = Selecione o formato de partida Counter-Strike
breachpoint-option-changed-match-format = Formato da partida definido como { $format }.
breachpoint-desc-match-format = Define o máximo de rounds regulamentares por metade e a pontuação necessária para vencer: 8 para MR7, 13 para MR12 ou 16 para MR15.
breachpoint-match-format-mr7 = MR7, primeiro a 8 rounds
breachpoint-match-format-mr12 = MR12, primeiro a 13 rounds
breachpoint-match-format-mr15 = MR15, primeiro a 16 rounds
breachpoint-set-overtime-mode = Resolução de empate: { $mode }
breachpoint-select-overtime-mode = Selecione como um empate regulamentar é resolvido
breachpoint-option-changed-overtime-mode = Resolução de empate definida como { $mode }.
breachpoint-desc-overtime-mode = Escolhe se uma partida regulamentar empatada termina empatada ou continua por períodos repetíveis de overtime MR3.
breachpoint-overtime-draw = Terminar em empate
breachpoint-overtime-mr3 = Repetir overtime MR3 até um esquadrão vencer

# Setup validation
breachpoint-error-even-teams = Breach Point exige duas equipes iguais. Há { $players } jogadores ativos no momento; use 4, 6, 8 ou 10.
breachpoint-error-match-format = O formato de partida { $format } não está disponível. Selecione MR7, MR12 ou MR15.
breachpoint-error-overtime-mode = O modo de overtime { $mode } não está disponível. Selecione uma resolução de empate registrada.
breachpoint-error-map-unavailable = O mapa tático { $map } não está disponível. Selecione um mapa registrado antes de começar.
...
breachpoint-node-unknown = Área desconhecida

# Dust spatial descriptions and terrain
breachpoint-area-t-spawn-description = Três rotas saem deste pátio rebaixado: Long, Mid e a aproximação pelos túneis.
breachpoint-area-outside-long-description = Um pátio aberto afunila para Long Doors, onde a rota fica bem mais estreita.
breachpoint-area-long-doors-description = Portas duplas pesadas separam a passagem de pedra apertada da rua exposta adiante.
breachpoint-area-pit-description = Este bolsão baixo no fim de Long oferece cobertura e uma visão limpa para A.
breachpoint-area-a-long-description = Uma rua larga sobe em direção a A Ramp, com pouca proteção entre posições de tiro.
breachpoint-area-a-ramp-description = A rua sobe aqui e se abre para A, tornando este o compromisso final vindo de Long.
breachpoint-area-a-site-description = O site elevado é aberto ao redor das caixas de bomba, com acessos por Long, Short e CT Spawn.
breachpoint-area-mid-description = Dust se abre aqui: Catwalk sobe para A, Mid Doors levam ao CT, e Lower Tunnels ramifica para B.
breachpoint-area-catwalk-description = Esta beirada elevada sai de Mid e vira para a aproximação mais apertada de Short A.
breachpoint-area-a-short-description = Uma rota alta e estreita observa A e a rotação CT abaixo.
breachpoint-area-mid-doors-description = As portas duplas enquadram o duelo central mais longo de Dust entre Mid e o território CT.
breachpoint-area-ct-mid-description = Esta junção liga Mid Doors, B Doors e a rota de rotação CT.
breachpoint-area-ct-spawn-description = CT Spawn é o principal centro de rotação, com rotas rápidas para A, B e Mid.
breachpoint-area-outside-tunnels-description = Um pátio protegido dá ao T um último ponto de reunião antes de entrar nos túneis.
breachpoint-area-upper-tunnels-description = A ampla câmara superior se divide para B ou desce por Lower Tunnels até Mid.
breachpoint-area-lower-tunnels-description = Este ramo subterrâneo apertado liga o sistema de túneis a Mid.
breachpoint-area-b-tunnels-description = O túnel se estreita em uma saída perigosa direto para B.
breachpoint-area-b-doors-description = Estas portas conectam B a CT Mid e à rotação dos defensores.
breachpoint-area-b-site-description = O site fechado envolve uma plataforma elevada e caixas empilhadas, com entradas por Tunnels e B Doors.
breachpoint-terrain-supply-crates = caixas de suprimentos empilhadas
breachpoint-terrain-double-doors = portas duplas pesadas
breachpoint-terrain-stone-pit-wall = a mureta baixa de Pit
breachpoint-terrain-disabled-car = um carro quebrado
breachpoint-terrain-ramp-boxes = caixas da rampa
breachpoint-terrain-bomb-crates = caixas de bomba
breachpoint-terrain-goose-wall = a parede Goose
breachpoint-terrain-xbox = a caixa central Xbox
breachpoint-terrain-catwalk-wall = a mureta baixa de Catwalk
breachpoint-terrain-short-boxes = caixas de Short
breachpoint-terrain-ct-boxes = caixas de cobertura CT
breachpoint-terrain-tunnel-pillars = pilares grossos do túnel
breachpoint-terrain-tunnel-corner = o canto cego do túnel
breachpoint-terrain-tunnel-crates = caixas do túnel
breachpoint-terrain-b-platform = a plataforma elevada de B

# Turn actions
breachpoint-weapon-none = sem arma
...
breachpoint-equipment-none = sem equipamento
breachpoint-equipment-defuse-kit = Defuse Kit
breachpoint-utility-none = sem utilitário
...
breachpoint-ammo-none = sem munição
...
breachpoint-ammo-status = { $loaded } de { $capacity } carregados; { $reserve } { $unit } na reserva
breachpoint-action-buy-weapon = Comprar { $weapon } por ${ $cost }; saldo ${ $cash }
breachpoint-action-buy-utility = Comprar { $utility } por ${ $cost }; carregando { $count } de { $maximum }; saldo ${ $cash }
breachpoint-action-buy-armor = Comprar { $armor } por ${ $cost }; saldo ${ $cash }
breachpoint-action-buy-equipment = Comprar { $equipment } por ${ $cost }; saldo ${ $cash }
breachpoint-action-donate-weapon = Comprar { $weapon } para { $player }: ${ $cost }; saldo ${ $cash }
breachpoint-action-accept-donation = Aceitar { $weapon } de { $player }
breachpoint-action-decline-donation = Recusar { $weapon } de { $player }
breachpoint-action-refund-item = Reembolsar { $item }, você tem { $count }; recuperar ${ $amount }; saldo ${ $cash }
breachpoint-action-finish-buy = Terminar compra; guardar ${ $cash }
breachpoint-buy-summary = Resumo do loadout: ${ $cash }; equipado { $equipped }; primária { $primary }; armor { $armor }; { $utility } granadas
breachpoint-buy-check-teammates = Ver dinheiro e equipamento dos colegas
breachpoint-buy-ground-weapons = Armas no chão
breachpoint-buy-refunds = Reembolsar compras
breachpoint-buy-for-teammate = Comprar para um colega
breachpoint-buy-category-equipment = Equipamento
breachpoint-buy-category-pistols = Pistolas
breachpoint-buy-category-mid-tier = Intermediárias
breachpoint-buy-category-rifles = Rifles
breachpoint-buy-category-grenades = Granadas
breachpoint-buy-category-unknown = Categoria indisponível
breachpoint-buy-shortcut-label = { $number }. { $item }
breachpoint-buy-donation-target = Comprar para { $player }
breachpoint-buy-no-refunds = Nenhuma compra reembolsável
breachpoint-error-no-ground-weapons = Não há armas no chão aqui.
breachpoint-buy-donation-waiting = Aguardando { $player } aceitar ou recusar { $weapon }
breachpoint-buy-back = Voltar ao menu de compra anterior
breachpoint-action-equip-weapon = Equipar { $weapon }
breachpoint-action-reload = Recarregar { $weapon }, { $ammunition } ({ $cost } AP)
breachpoint-action-reload-keybind = Recarregar arma equipada
breachpoint-action-pick-up-weapon = Pegar { $weapon }, { $ammunition } ({ $cost } AP)
breachpoint-action-exchange-weapon = Trocar { $replaced } por { $weapon }, { $ammunition } ({ $cost } AP)
breachpoint-action-buy-pick-up-weapon = Pegar { $weapon }, { $ammunition }; grátis durante sua compra
breachpoint-action-buy-exchange-weapon = Trocar { $replaced } por { $weapon }, { $ammunition }; grátis durante sua compra
breachpoint-action-hold-angle = Segurar ângulo com { $weapon } para { $location } ({ $cost } AP; encerra ativação)
breachpoint-action-throw-utility = Arremessar { $utility } em { $location } ({ $cost } AP; { $count } carregado)
breachpoint-action-move = Mover para { $location } ({ $cost } AP)
breachpoint-action-disengage = Disengage para { $location } ({ $cost } AP; encerra ativação)
breachpoint-action-move-fire = Mover para o fogo em { $location } ({ $cost } AP; sofre dano de fogo)
breachpoint-action-disengage-fire = Disengage para o fogo em { $location } ({ $cost } AP; sofre dano de fogo; encerra ativação)
breachpoint-action-shoot = Atirar em { $player } com { $weapon } em { $location }, { $health } de vida, { $armor } armor, { $guard } evasão, { $ammunition }, { $strength } ({ $cost } AP)
breachpoint-action-shoot-unavailable = Atirar em alvo indisponível
breachpoint-shot-strength-full = força total
breachpoint-shot-strength-followup = limitado por recuo a { $percent } por cento de dano
breachpoint-action-plant = Começar a plantar a bomba ({ $cost } AP)
breachpoint-action-defuse = Desarmar a bomba ({ $cost } AP)
breachpoint-action-pickup = Pegar a bomba ({ $cost } AP)
breachpoint-action-end-turn = Encerrar ativação; preparar { $guard } de evasão
breachpoint-action-skip-round-recovery = Pular recuperação de arma e encerrar o round
breachpoint-action-reaction-shoot = Disparar a { $weapon } segurada em { $player } em { $location } ({ $percent } por cento de dano)
breachpoint-action-reaction-pass = Não atirar e manter o ângulo
breachpoint-keybind-finish-or-end = Terminar compra ou encerrar ativação
breachpoint-keybind-buy-shortcut = Atalho { $number } do menu de compra
breachpoint-keybind-menu-back = Voltar ao menu de jogo anterior
