...
chess-draw-timeout-insufficient = Empate. O oponente estourou o tempo, mas não havia material de xeque suficiente.
...
chess-you-promote-to = Você promove o peão em { $square } para uma/um { $piece }.
chess-player-promotes-to = { $player } promove o peão em { $square } para uma/um { $piece }.
