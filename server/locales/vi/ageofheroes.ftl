...
ageofheroes-special-bricks = Gạch nung
...
ageofheroes-dice-tie = Nhiều người chơi hòa nhau với { $total } điểm. Đang gieo lại...
...
ageofheroes-earthquake = Một trận động đất đánh vào tộc của { $player }; quân đội của họ rơi vào trạng thái hồi phục.
ageofheroes-earthquake-you = Một trận động đất đánh vào tộc của bạn; quân đội của bạn rơi vào trạng thái hồi phục.
...
ageofheroes-lose-card-barbarians = Bạn mất { $card }.
...
ageofheroes-trade-cancelled = { $player } rút lại lời đề nghị đổi { $card }.
ageofheroes-trade-cancelled-you = Bạn rút lại lời đề nghị đổi { $card }.
ageofheroes-stop-trading = Dừng trao đổi
ageofheroes-select-request = Bạn đang đề nghị đổi { $card }. Bạn muốn nhận lại gì?
ageofheroes-cancel = Hủy
ageofheroes-left-auction = { $player } rời đi.
ageofheroes-left-auction-you = Bạn rời khỏi khu chợ.
...
ageofheroes-tax-no-city = Thu thuế: Bạn không còn thành phố nào. Bỏ một lá bài để rút lá mới.
...
ageofheroes-road-request-received = { $requester } yêu cầu cho phép làm đường tới tộc của bạn.
...
ageofheroes-road-no-target = Không có tộc láng giềng nào để làm đường.
...
ageofheroes-war-bonuses-you = { $general ->
    [0] {
        { $fortress ->
            ...
            *[other] {"+{ $fortress } từ các pháo đài = tổng { $total }"}
        }
    }
    *[other] {
        { $fortress ->
            ...
            *[other] {"+{ $general } từ tướng quân, +{ $fortress } từ các pháo đài = tổng { $total }"}
        }
    }
}
ageofheroes-war-bonuses-other = { $general ->
    [0] {
        { $fortress ->
            ...
            *[other] {"{ $player }: +{ $fortress } từ các pháo đài = tổng { $total }"}
        }
    }
    *[other] {
        { $fortress ->
            ...
            *[other] {"{ $player }: +{ $general } từ tướng quân, +{ $fortress } từ các pháo đài = tổng { $total }"}
        }
    }
}
...
ageofheroes-dice-roll-detailed = { $name } gieo được { $dice }{ $general ->
   ...
   *[other] { " + { $general } từ tướng quân" }
    ...
    [0] {""}
    [one] { " + 1 từ pháo đài" }
   *[other] { " + { $fortress } từ các pháo đài" }
} = { $total }.
...
ageofheroes-round-attacker-wins = { $attacker } thắng vòng này ({ $att_total } vs { $def_total }). { $defender } mất một đơn vị quân.
ageofheroes-round-defender-wins = { $defender } phòng thủ thành công ({ $def_total } vs { $att_total }). { $attacker } mất một đơn vị quân.
...
ageofheroes-army-returned = Quân của { $player } đã trở về từ chiến trường.
ageofheroes-army-returned-you = Quân của bạn đã trở về từ chiến trường.
...
ageofheroes-discard-excess-other = { $player } phải bỏ các lá bài thừa.
...
ageofheroes-victory-monument-you = Bạn đã hoàn thành kỳ quan của mình! Những người mang nền văn hóa vĩ đại.
ageofheroes-victory-last-standing = { $player } là tộc cuối cùng còn trụ lại! Kẻ Kiên Cường Nhất.
...
ageofheroes-status-none = không
ageofheroes-status-earthquake-armies = Quân đội đang hồi phục: { $count }
