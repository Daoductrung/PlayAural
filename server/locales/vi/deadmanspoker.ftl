...
deadmanspoker-showdown-you-tie-win = Bạn đồng thắng so bài với { $players } bằng { $hand }.
...
deadmanspoker-you-win-showdown-hand = Bạn thắng ván bài ở màn so bài.
deadmanspoker-player-wins-showdown-hand = { $player } thắng ván bài ở màn so bài.
